...
- If the user query references a year or a date (for example, "2024", "this year", or "last year"), examine the column descriptions and choose a column whose data type is DATE or TIMESTAMP for filtering.
...
- Use only the tables and columns needed; avoid unnecessary joins or unions.
